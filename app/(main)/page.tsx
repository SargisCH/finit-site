            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <Link href="#contact">
                  <Button
                    variant="outline"
                    className="border-slate-300 text-slate-700 font-semibold px-6 hover:bg-slate-50"
                  >
                    Contact Us
                  </Button>
                </Link>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-white rounded-xl p-4 shadow-sm">
                      <div className="flex items-end gap-1.5 h-16 justify-center">
                        {[40, 65, 50, 80, 60, 90, 70, 55, 85, 45].map(
                          (h, i) => (
                            <div
                              key={i}
          ...
          <div className="relative rounded-2xl overflow-hidden">
            <div className="w-full h-72 md:h-96 bg-gradient-to-br from-slate-800 to-slate-900 flex items-center justify-center">
              ...
              <div className="flex items-end gap-2 h-40 px-8">
                {[
                  50, 70, 45, 85, 60, 95, 55, 80, 65, 90, 50, 75, 85, 60, 95,
                ].map((h, i) => (
