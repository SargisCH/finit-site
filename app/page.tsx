...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section
        id="evaluation"
        className="dark bg-[#0f172a] flex flex-col items-center justify-center px-4 text-center py-16 md:py-24"
      >
        <div className="max-w-2xl space-y-6">
          <div className="space-y-3">
            ...
            <p className="text-lg text-slate-300 md:text-xl max-w-xl mx-auto">
              Our platform works seamlessly with complex financial data to
              provide you with actionable intelligence.
            </p>
          </div>
          ...
          <div className="relative group p-1 rounded-2xl bg-gradient-to-br from-primary/30 to-transparent max-w-xl mx-auto">
            <Card className="bg-[#1e293b] rounded-xl p-6 md:p-10 border border-slate-700/50 shadow-2xl space-y-4 relative text-white">
              ...
              <p className="text-base text-slate-300">
                Ever wondered what your company is worth in today's market? Use
                our free calculation tool to get an instant valuation.
              </p>
              <div className="pt-2">
                <Link
                  href="http://185-47-174-99.cloud-xip.com:5173/"
                  target="_blank"
                >
                  <Button
                    size="default"
                    className="px-6 font-bold shadow-lg shadow-primary/20 hover:scale-105 transition-transform bg-primary text-[#022c22] hover:bg-primary/90"
                  >
                    Try it now
                  </Button>
                </Link>
          ...
          >
            <div className="text-left space-y-2">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Stay ahead with data that updates as the market moves, ensuring
                accurate analysis.
              </p>
            </div>
            <div className="text-left space-y-2">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Advanced algorithms designed for financial accuracy and risk
                management.
              </p>
            </div>
            <div className="text-left space-y-2">
          ...
          <div id="plans" className="space-y-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
              ...
              <Card className="border-slate-200 shadow-sm flex flex-col py-6 hover:shadow-md transition-shadow bg-white">
                ...
                <CardFooter>
                  ...
                  >
                    <Button
                      variant="outline"
                      className="w-full h-10 border-slate-300 text-slate-900 hover:bg-slate-50 font-bold"
                    >
                      Get Started
                    </Button>
                  </Link>
              ...
              <Card className="dark border-slate-700 shadow-2xl relative flex flex-col bg-[#0f172a] text-white py-6 scale-105 z-10 border-2">
                ...
                <CardFooter>
                  <Button className="w-full h-10 font-bold bg-primary text-[#022c22] hover:bg-primary/90 transition-all">
                    Try Now
                  </Button>
                </CardFooter>
              </Card>
